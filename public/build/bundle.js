...
var app = (function () {
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", "svelte-1vhhyq8");
    			add_location(ul, file$9, 5, 4, 73);
    			attr_dev(nav, "class", "svelte-1vhhyq8");
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$7, 4, 0, 70);
    			add_location(br, file$7, 9, 2, 166);
    			attr_dev(input1, "id", "precio");
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "placeholder", "Precio");
    			add_location(input1, file$7, 10, 0, 173);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (32:0) <Pieza bind:pieza={piezaInsertar}>
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(32:0) <Pieza bind:pieza={piezaInsertar}>",
    		ctx
    	});
    ...
    // (37:0) {#each datosFiltrados as pieza}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			br2 = element("br");
    			add_location(br0, file$5, 37, 4, 806);
    			add_location(br1, file$5, 42, 4, 958);
    			add_location(br2, file$5, 43, 4, 969);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(37:0) {#each datosFiltrados as pieza}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(hr, file$5, 29, 0, 670);
    			add_location(br, file$5, 34, 0, 762);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "Nombre");
    			add_location(input0, file$4, 4, 0, 76);
    			add_location(br0, file$4, 9, 2, 174);
    			attr_dev(input1, "id", "apellido");
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "placeholder", "Apellidos");
    			add_location(input1, file$4, 10, 0, 181);
    			add_location(br1, file$4, 15, 2, 287);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (32:0) <Cliente bind:cliente={clienteInsertar}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(32:0) <Cliente bind:cliente={clienteInsertar}>",
    		ctx
    	});
    ...
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(39:4) <Cliente bind:cliente>",
    		ctx
    	});
    ...
    // (37:0) {#each datosFiltrados as cliente}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			br2 = element("br");
    			add_location(br0, file$2, 37, 4, 841);
    			add_location(br1, file$2, 42, 4, 1003);
    			add_location(br2, file$2, 43, 4, 1014);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, br0, anchor);
    			insert_dev(target, t0, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(37:0) {#each datosFiltrados as cliente}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(hr, file$2, 29, 0, 693);
    			add_location(br, file$2, 34, 0, 795);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
